export const FR = {
    ...
    BatteryFuelEconomyDesc: "Le carburant via les batteries rechargeable s'améliore de 100% (soit 50% du coût du carburant)",
    ...
    PumpkinBatteryDesc: "Tous les batiments consommant des piles utilisent des citrouilles à la place (Politique GRATUITE)",
    PumpkinSteel: "Citrouille d'Acier",
    PumpkinSteelDesc: "Tous les batiments consommant de l'acier utilisent des citrouilles à la place (Politique GRATUITE)",
    ...
    StreamAutoApproveDesc: "Autoriser les autres joueurs à joindre votre diffusion sous conditions de votre validation individuelle pour chaque demande",
    ...
    StreamingPlayerRequested: "%{player} vous demande s'il peut visionner votre diffusion, allez dans le Siège social pour accepter ou refuser",
